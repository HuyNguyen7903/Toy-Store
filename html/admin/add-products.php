...
if(strtoupper($_SERVER['REQUEST_METHOD']) === 'POST'){
    ...
    $url = $pms['data']['link'];
    //Thêm sản phẩm
    if(insert("INSERT INTO products(name,price, img, description, cate_id, brand) values(?,?,?,?,?,?)",array($name,$price, $url, $description, $cate_id,$brand))){
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-8">
                                            <div class="form-group mb-3">
                                              ...
                                              <input type="text" class="form-control" id="name" name="name" oninvalid="setCustomValidity('Vui lòng nhập tên')" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group">
                                                <label for="price">Giá:</label>
                                                <input type="text" class="form-control" id="price" name="price" pattern="[0-9,]*" oninvalid="setCustomValidity('Vui lòng nhập giá là số')" required>
                                              </div>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <div class="form-group mb-3">
                                              ...
                                              <img src="https://placehold.co/300x300" class="img-fluid" id="image-show">
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-3">
